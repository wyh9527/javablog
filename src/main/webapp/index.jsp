           ...
           <c:forEach items="${pageInfo.list}" var="blog">
                ...
                <div>
                  <div class="sb">                    
                    ...
                    <div class="entry-meta-wrap clearfix">
                      <ul class="entry-meta">
                        <li class="entry-date">
                          <a href="${pageContext.request.contextPath}/IndexgetBlogbyid.do?id=${blog.id}"><c:out value="${blog.releaseDate}"/></a>
                        </li>                 
              ...
              <div class="row mt-20">
                ...
                <c:if test="${pageInfo.hasPreviousPage}">
                  <a href="${pageContext.request.contextPath}/index/${pageInfo.pageNum-1}.do" class="btn btn-md btn-stroke" id="load-more">Previous Page</a>
                  </c:if>
                  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                 	<c:if test="${pageInfo.hasNextPage}"> 
                  <a href="${pageContext.request.contextPath}/index/${pageInfo.pageNum+1}.do" class="btn btn-md btn-stroke" id="load-more">Next   Page</a>
                  </c:if>
                </div>
              </div>
